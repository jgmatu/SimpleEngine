...
Cube::Cube(std::string id_mesh)
{
    generateCubeMesh(id_mesh);
}
...
void Cube::generateCubeMesh(std::string id_mesh)
{
    //Describimos un cubo (Hardcodeado...)
    //*******************
    ...
    */
    ...
    for (uint32_t i = 0, j = 0; i < __cubeVertices.size(); i += 5, j += 3) {
        Vertex vertex;
